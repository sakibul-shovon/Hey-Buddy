...
import { Search, Filter, Plus, Star, MessageCircle, DollarSign, Clock, Tag, Users } from 'lucide-react';
...
const MicroProjectsPage = () => {
  ...
  const categories = ['All', 'Web Development', 'Mobile App', 'UI/UX Design', 'AI/ML', 'Blockchain', 'Digital Marketing', 'DevOps', 'Other'];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">MicroProjects</h1>
          <p className="mt-2 text-sm text-gray-500">Find quick tasks, collaborate, and grow your skills</p>
        </div>
        ...
        <div className="p-6">
          <div className="flex flex-col md:flex-row justify-between mb-6">
            ...
            <div className="flex space-x-4">
              ...
              <select className="appearance-none bg-white border border-gray-300 rounded-md py-2 pl-3 pr-10 text-base focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
          ...
          {activeTab === 'my-projects' && (
            <div className="text-center py-12">
              ...
              <button className="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md inline-flex items-center">
                <Plus size={18} className="mr-2" />
    ...
    <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-200">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        {project.skills.map((skill, index) => (
          <span key={index} className="bg-indigo-50 text-indigo-700 text-xs font-medium px-2.5 py-0.5 rounded">
            {skill}
          </span>
        ))}
      </div>
      ...
      <div className="mt-6 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div className="ml-2">
            ...
            <div className="flex items-center">
              ...
              <span className="text-xs text-gray-500 ml-1">{project.rating} • {project.reviewCount} reviews</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center text-gray-500">
            ...
            <span className="text-xs">{project.bids} bids</span>
          </div>
        </div>
      </div>
...
const sampleProjects = [
  {
    ...
    category: "Mobile App",
    description: "We need a skilled mobile developer to create a fintech app that integrates with bKash API and includes features like bill payment, fund transfer, and spending analytics for Bangladesh market.",
