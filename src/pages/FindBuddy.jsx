...
// Mock data - 10 Bangladeshi users with random images
const mockUsers = [
  {
    id: 1,
    name: "Tanvir Ahmed",
...
const FindBuddy = () => {
  ...
  // Filter users based on skills and interests
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="md:flex">
            ...
            <div className="p-8">
              ...
              <p className="mt-4 text-gray-600">{currentUser.bio}</p>
              ...
              <div className="mt-6 flex justify-end gap-4">
                <button
                  onClick={handleSkip}
                  className="bg-gray-200 px-6 py-2 rounded-lg hover:bg-gray-300 transition flex items-center gap-2"
                >
                  <X size={20} />
                  Next
                </button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {connections.map((connection) => (
              ...
              >
                ...
                <button className="mt-3 w-full bg-blue-100 text-blue-800 px-4 py-2 rounded-lg hover:bg-blue-200 transition flex items-center justify-center gap-2">
